...
function Hero() {
  return (
    <div className="hero w-full h-screen bg-primary/90 py-10 px-5 bg-hero-texture">
      <div className="container mx-auto h-full">
        <Navbar />
        <div className="hero-content w-full h-[calc(100%-100px)] grid grid-cols-2 gap-4 flex content-center">
