...
function CategoryCard({ name, icon }) {
  return (
    <div className="w-full shadow-lg rounded-2xl mb-4 flex items-center content-center justify-center dark:bg-slate-800 overflow-hidden bg-white">
      <div className="cat-icon p-5 border-e border-dashed border-gray-600/20">
        <Icon
          icon={icon}
          type="img"
          width="50px"
      ...
      <div className="cat-name py-5 pe-5 text-center text-primary capitalize text-sm sm:text-xl font-medium w-full dark:text-white truncate">
        {name}
      </div>
    </div>
  );
